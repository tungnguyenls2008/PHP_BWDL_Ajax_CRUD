...
$('.modal-footer').on('click', '.add', function() {
   // let myForm = $('#myForm')[0];
    ...
    formData.append('content_post',$('#content_add').val())
    formData.append('cover_image',$('input[type=file]')[0].files[0])
    $.ajaxSetup(
        {
            headers:
                {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if ((data.errors)) {
                ...
                toastr.success('Successfully updated Post!', 'Success!', {timeOut: 5000});
...
$('.modal-footer').on('click', '.delete', function() {
    $.ajax({
        ...
        success: function(data) {
            toastr.success('Successfully deleted Post!', 'Success!', {timeOut: 5000});
            $('.item' + data['id']).remove();
            $('.col1').each(function (index) {
                $(this).html(index+1);
            });
